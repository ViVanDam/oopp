...
public class Employee {
	...
	public String toString() {
		String typeString = "";
		if (String.valueOf(getEmployee_type()).equalsIgnoreCase("0")) {
			typeString = "Experience";
		} else if (String.valueOf(getEmployee_type()).equalsIgnoreCase("2")) {
			typeString = "Intern";
		} else if (String.valueOf(getEmployee_type()).equalsIgnoreCase("1" + "")) {
			typeString = "Fresher";
		}
